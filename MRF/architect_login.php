...
// Redirect if architect is already logged in
if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true && $_SESSION["role"] === "architect") {
    header("location: architect_index.php");
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        $sql = "SELECT id, username, password FROM architect WHERE username = ?";
                ...
                if ($stmt->num_rows == 1) {
                    ...
                    if ($stmt->fetch()) {
                        if (password_verify($password, $hashed_password)) {
                            ...
                            $_SESSION["architect_loggedin"] = true;
                            $_SESSION["architect_id"] = $id;
                            $_SESSION["architect_username"] = $username;
                            $_SESSION["role"] = "architect"; // important
                            header("location: architect_index.php");
                            exit;
                        } else {
...
<body>
    ...
    <img src="/gnlproject/img/logo.png" alt="Logo" style="width: 200px; align:top;" class="rounded-pill">
        ...
        <form action="architect_login.php" method="post">
