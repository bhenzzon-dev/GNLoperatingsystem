...
$query = "SELECT id, employee_name, particulars, amount, created_at FROM reimbursements WHERE project_id = ? AND status = 'released'";
...
<div class="container content">
  <h3 class="text-center mb-4">Reimbursement Expenses for Project: <?= htmlspecialchars($project_name) ?></h3>
    ...
    <table class="table table-striped">
      ...
      <tbody>
        <?php if ($result->num_rows > 0): ?>
          ...
          <?php endwhile; ?>
        <?php else: ?>
          <tr><td colspan="5" class="text-center">No reimbursement records found.</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
