...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['release_now'])) {
    ...
    SELECT 
         po_number, item_description, qty, unit, unit_price, total_price, supplier_name, address, contact_number, contact_person, 
         ship_project_name, ship_address, ship_contact_number, ship_contact_person, created_at, date, particulars, po_num, 
         'released' AS status,  -- force status to 'released'
         mrf_id,
    ...
    ";
        ...
        $conn->commit();
        header("Location: admin_summary_approved.php?release=success");
        exit;
    ...
    header("Location: admin_summary_approved.php");
    exit;
}
?>
