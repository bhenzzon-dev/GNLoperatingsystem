...
$poQuery = "SELECT * FROM summary_approved WHERE status = 'hold' ORDER BY po_number, id";
...
<head>
    <meta charset="UTF-8">
    <title>Hold Summary | Admin Panel</title>
