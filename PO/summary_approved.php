...
$sqlUe = "
    SELECT m.id, p.project_name, m.utility_type, m.amount, m.account_number, m.billing_period
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="approved_pdf.php">Summary Form</a></li>
...
<!-- Release Now Button -->
<form id="releaseForm" method="POST" action="release_po_item.php">
...
<div class="tab-pane fade" id="content-payroll" role="tabpanel">
  ...
  <div class="tab-pane fade" id="content-Im" role="tabpanel">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php if (count($ImRows) > 0): ?>
                <?php foreach ($ImRows as $row): ?>
                    <tr>
                        <td><?= htmlspecialchars($row['project_name']) ?></td>
                        <td><?= htmlspecialchars($row['particulars']) ?></td>
                        <td><?= htmlspecialchars($row['category']) ?></td>
