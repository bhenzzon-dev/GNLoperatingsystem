...
<head>
    <meta charset="UTF-8">
    <title>Miscellaneous Expenses Form | Admin Panel</title>
...
<div class="container content form-container">
    <h3>Miscellaneous Expenses Form</h3>

    <!-- Miscellaneous Expenses Form -->
    <form action="submit_misc_expenses.php" method="POST">
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group col">
                ...
                <input type="text" id="tin_number" name="tin_number" placeholder="Enter TIN number (optional)">
            </div>

            <div class="form-group col">
                <label for="invoice_number">Invoice Number</label>
                <input type="text" id="invoice_number" name="invoice_number" placeholder="Enter invoice number (optional)">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col">
                ...
                <textarea id="particulars" name="particulars" rows="4" placeholder="Enter particulars"></textarea>
            </div>
...
<script>
    <?php if ($successMessage): ?>
        Swal.fire({
            icon: 'success',
            title: 'Success!',
            text: 'The miscellaneous expense has been successfully added.',
