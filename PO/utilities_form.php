...
<head>
    <meta charset="UTF-8">
    <title>Utilities Form | Admin Panel</title>
...
<div class="container form-container">
    <h3>Utilities Expense Form</h3>

    <form action="submit_utilities_expense.php" method="POST">
        <div class="form-row">
            ...
            <div class="form-group col">
                ...
                <input type="text" id="utility_type" name="utility_type" required placeholder="e.g., Electricity, Water, Internet">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col">
                ...
                <input type="text" id="billing_period" name="billing_period" required placeholder="e.g., March 2025">
            </div>

            <div class="form-group col">
                <label for="account_number">Account Number</label>
                <input type="text" id="account_number" name="account_number" required placeholder="Utility account number">
            </div>
        </div>
        ...
        <div class="form-group">
            <input type="submit" value="Submit Utility Expense">
        </div>
    </form>
</div>
...
<script>
    <?php if ($successMessage): ?>
        Swal.fire({
            icon: 'success',
            title: 'Success!',
            text: 'The utility expense has been successfully added.',
  ...
  fetch('get_pending_count.php')
    ...
    .then(count => {
      ...
      if (num > 0) {
        ...
        animateTitleStart(); // Start title animation
      } else {
        badge.style.display = 'none';
        animateTitleStop();  // Stop title animation
      }
    })
